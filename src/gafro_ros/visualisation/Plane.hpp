...
{
    class Plane : public sackmesser_ros::Publisher<visualization_msgs::Marker, gafro::Plane<double>>
    {
      public:
        Plane(const std::string &name, sackmesser_ros::Interface *interface);

        ~Plane();

        visualization_msgs::Marker createMessage(const gafro::Plane<double> &plane) const;
