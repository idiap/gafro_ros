...
{
    class Sphere : public sackmesser_ros::Publisher<visualization_msgs::Marker, gafro::Sphere<double>>
    {
      public:
        Sphere(const std::string &name, sackmesser_ros::Interface *interface);

        ~Sphere();

        visualization_msgs::Marker createMessage(const gafro::Sphere<double> &sphere) const;
